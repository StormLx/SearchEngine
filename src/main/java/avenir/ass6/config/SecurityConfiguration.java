package avenir.ass6.config;

import avenir.ass6.controller.handler.AccessDenialHandler;
import avenir.ass6.controller.handler.AuthenticationHandler;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/", "/logout", "/index", "/login", "/read**").permitAll()
